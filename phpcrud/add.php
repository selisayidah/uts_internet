...
$connect  = new mysqli($server, $user, $password, $db);
    ...
    if ( $_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        do{
            if (empty($npsn) || empty($status) ||empty($bentuk_pen) || empty($nama_sekolah) ||empty($sk_pendirian) || empty($pendirian) || empty($sk_op) ||empty($tgl_op) || empty($alamat) || empty($rt) || empty($rw) || empty($dusun) ||empty($desa) || empty($kec) || empty($kab_kota) || empty($prov)|| empty($pos)){
            ...
            $sql = "INSERT INTO sekolah_data (npsn, status, bentuk_pendidikan, nama_sekolah, sk_pendirian, tgl_pendirian, sk_izin_operasional, tgl_izin_operasional, alamat, rt, rw, dusun, desa, kecamatan, kabupaten_kota, provinsi, kode_pos)"
            ."VALUES ('$npsn', '$status','$bentuk_pen','$nama_sekolah', '$sk_pendirian', '$pendirian', '$sk_op','$tgl_op', '$alamat','$rt','$rw', '$dusun','$desa','$kec', '$kab_kota','$prov','$pos')";
  ...
  <div class="col-sm-6">
        <form method="post">
          ...
          <div class="row mb-3">
              ...
              <div class="col-sm-6">
                  <input type="date" class="form-control" name="tgl_pendirian" value="<?php echo $pendirian; ?>">
              </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
              ...
              <div class="col-sm-6">
                  <input type="date" class="form-control" name="tgl_operasional" value="<?php echo $tgl_op; ?>">
              </div>
          </div>
